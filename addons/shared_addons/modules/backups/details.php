...
class Module_Backups extends Module {
	...
	public function info()
	{
		return array(
			...
			'description' => array(
				...
				'fr' => 'Backup all your important data to Amazon S3, Dropbox, Email or by direct download.'
	...
	public function install()
	{
		...
		$accounts = "CREATE TABLE ".$this->db->dbprefix('backup_accounts')." (
						  ...
						  account_type enum('email','amazons3', 'dropbox') NOT NULL,
	...
	public function upgrade($old_version)
	{
		$fields = array('account_type' => array(
							'name' => 'account_type',
							'type' => 'enum(\'email\',\'amazons3\', \'dropbox\') NOT NULL',
				),
		);
